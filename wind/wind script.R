...
ggsave("Boxplot_WindSpeed_Comparison.png", p1, width = 7, height = 4.5, dpi = 600)
...
print("Monthly Statistics (ME, RMSE, R) for Wind Speed:")
print(monthly_stats)
...
print("Overall Statistics (ME, RMSE, R) for Wind Speed:")
print(overall_stats)

# --- 4. Export to CSV and Excel ---
write.csv(monthly_stats, "Monthly_WindSpeed_Stats.csv", row.names = FALSE)
write.csv(overall_stats, "Overall_WindSpeed_Stats.csv", row.names = FALSE)
